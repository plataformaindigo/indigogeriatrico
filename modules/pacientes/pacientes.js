...
try {
    ...
    if (
        ...
        Array.isArray(padron)
    ) {

        throw new Error(
            'El servidor no devolvió un objeto de padrón válido.'
        );
...
return [
    ...
    paciente.servicio_emergencia_id
...
alert(
    ...
    `Institución de derivación: ${
        paciente.institucion_derivacion_id || '-'
    }\n` +
...
if (
    typeof paciente.cobertura_json ===
    'object'
) {

    return paciente.cobertura_json;
...
try {
    ...
    console.warn(
        'No se pudo interpretar cobertura_json:',
        error
    );
